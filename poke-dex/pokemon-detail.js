...
function rgbaFromHex(hexColor) {
    return [
        parseInt(hexColor.slice(1, 3), 16), parseInt(hexColor.slice(3, 5), 16), parseInt(hexColor.slice(5, 7), 16)
    ].join(", ");
}
...
function setTypeBackgroundColor(pokemon) {
    ...
    setElementStyles(document.querySelectorAll(".stats-wrap p.stats"), "backgroundColor", color);

    // setElementStyles(document.querySelectorAll(".stats-wrap .progress-bar"), "backgroundColor", color);
...
function displayPokemonDetails(pokemon) {
    ...
    stats.forEach(({ stat, base_stat }) => {
        ...
        statDiv.classList.add("stats-wrap");
